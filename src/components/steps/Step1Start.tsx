            ...
            return (
              <div
                ...
                className={`relative pro-card overflow-hidden transition-all duration-300 ${
                  cat.available
                    ? 'hover:-translate-y-1 hover:shadow-[0_8px_40px_rgba(0,0,0,0.5)]'
                    : 'opacity-70'
                } ${isHovered && cat.available ? 'border-[var(--neon)] shadow-[0_0_30px_var(--neon-glow)]' : ''}`}
              >
                {/* Зона фото — только карандашик, без onClick перехода */}
                ...
                {/* Зона контента — клик ведёт на следующий шаг */}
                <div
                  ...
                  {cat.available && (
                    <div
                      className={`flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 ${
                        isHovered ? 'scale-110 shadow-[0_0_12px_rgba(61,90,254,0.5)]' : ''
                      }`}
